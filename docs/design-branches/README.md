...
DB-045 持久表示 ID 与 DB-046 统一闭合目录均已完成；DB-047 为推荐后继，尚未实施：

| 文档 | 状态 | 实施范围 |
|---|---|---|
| [DB-047 List<T> 内容对象](0047-list-content-object-slice.md) | Proposed / 待采纳 | 完整受支持槽组合、可变长度融合 Delta、List owner Upgrade、统一目录及 history/真实包计划；本轮仅规划 |
