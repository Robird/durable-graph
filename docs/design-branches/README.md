...
| 文档 | 状态 | 实施范围 |
|---|---|---|
| [DB-043 可组合数组与统一引用对象路径](0043-vector-array-object-slice.md) | Proposed | 施工级修订：统一 object 分派 string/class/array；SZ/rank 2–4、开放泛型/jagged/inline 元素、融合 Delta、数组 owner Upgrade 与真实包闭环；版本化表示头统一寻址独立待办 |
