...
| 文档 | 状态 | 实施范围 |
|---|---|---|
| [DB-055 复合 Key 的持久状态与当前比较](0055-composite-dictionary-key-design.md) | 分层方向已采纳 / 修订方案未实施 | 推荐 Default 零配置、Application 当前绑定与标准模式保留；泛型 resolver、模式回捕、分阶段查重及 G0–G3 验收；旧固定持久字段 comparer 推荐已归档 |
