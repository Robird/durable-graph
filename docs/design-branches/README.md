...
| 文档 | 状态 | 实施范围 |
|---|---|---|
| [DB-058 DateOnly / TimeOnly / DateTimeOffset 内建值槽](0058-temporal-scalar-value-slice.md) | Proposed / 待采纳 | 三值完整公开表示、offset 持久相等性、静态 body/组合/history 的下一片建议；DateTime Local/DST 另定，尚未实施 |
