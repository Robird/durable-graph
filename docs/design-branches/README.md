...
| [DB-009](0009-base-lineage-parent-locator.md) | Base lineage direct parent 与 Revision locator | Open | planner source authority 迁移、lineage read amplification 或 DurableId 重新接入裁决 |
