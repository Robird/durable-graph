...
| 文档 | 状态 | 实施范围 |
|---|---|---|
| [DB-054 Dictionary 内容对象](0054-dictionary-content-object-slice.md) | Proposed / 待采纳 | 双槽冻结、无序映射、持久 key body 寻址 Delta；key/comparer 推荐矩阵及 Sorted/Ordered 复用边界，尚未实施 |
