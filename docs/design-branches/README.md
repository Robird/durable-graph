...
| [DB-009](0009-base-lineage-parent-locator.md) | Base lineage direct parent 与 Revision locator | Open | 可回放 OVD reader、planner materialization、multi-frame relay planning 或 DurableId 重新接入裁决 |
