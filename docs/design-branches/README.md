...
| [DB-024](0024-reference-capture-and-reusable-object-ids.md) | 引用 Capture、revision 内身份与可复用 ObjectId | 首片方向已确认 | 首片单调 ID + 引用 Capture/候选生命周期；工作单/Goal 待评审，回收/恢复/struct 延期 |
