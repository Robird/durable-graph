...
public static class FixtureLoadedWorld {
    /// <summary>
    ...
    /// </summary>
    public static FixturePreparedWorldRevision PrepareNew<TWorld>(
    ...
    /// </summary>
    public static FixtureLoadedWorld<TWorld> Load<TWorld>(
        StateRevisionStore store,
        SchemaStore schemas,
...
public sealed class FixturePreparedWorldRevision {
    internal FixturePreparedWorldRevision(ObjectId worldId, StateRevision revision) {
        WorldId = worldId;
        Revision = revision;
    }
